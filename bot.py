...
from pyrogram.types import BotCommand, BotCommandScopeAllPrivateChats, InlineKeyboardMarkup, InlineKeyboardButton
...
class Bot(Client):
    ...
    async def kirim_pesan_rekber(self, x: str, rekber_url: str):
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Rekening Bersama", url=rekber_url)]
        ])
        await self.send_message(config.id_admin, "Klik tombol di bawah untuk informasi Rekening Bersama:", reply_markup=keyboard)

    async def rekber_command(self, message):
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Rekening Bersama", url="https://example.com/rekber")]
        ])
        await message.reply_text("Silakan klik tombol di bawah untuk informasi Rekening Bersama:", reply_markup=keyboard)
